...
--
-- Host: localhost
-- Generation Time: Oct 30, 2025 at 07:53 AM
...
(52, 'FLRIAZ7SKX', 'img_68f5c1bb20143.png', 205746.00, 5, 1, '2025-10-20 11:59:00', '2025-10-20 11:59:39'),
(53, 'SFQLMAVQWQ', 'img_68f5d7e7d74b8.jpeg', 96853.00, 3, 1, '2025-10-20 13:33:00', '2025-10-20 13:34:15');
...
INSERT INTO `stock_product` (`product_id`, `product_name`, `product_count`, `product_price`, `price_center`, `count_cord`, `shipping_cost`, `expenses`, `id_adder`, `id_order`, `create_at`) VALUES
(99, '11', 100, 300.00, 300.00, 5000, 2750.00, 32750.00, 1, 52, '2025-10-20 11:59:39'),
(100, '10', 120, 400.00, 430.50, 6000, 3648.00, 51648.00, 1, 52, '2025-10-20 11:59:39'),
(101, '1', 70, 300.00, 400.00, 3500, 525.00, 21525.00, 1, 52, '2025-10-20 11:59:39'),
(103, '8', 100, 270.00, 300.00, 5000, 2023.00, 29023.00, 1, 52, '2025-10-20 13:32:53'),
(104, '9', 200, 200.00, 230.70, 10000, 5000.00, 45000.00, 1, 53, '2025-10-20 13:34:15'),
(106, '7', 130, 155.50, 177.70, 7800, 1638.00, 21853.00, 1, 53, '2025-10-20 13:36:04'),
(107, '5', 120, 570.00, 630.00, 6000, 2400.00, 70800.00, 1, 52, '2025-10-24 13:16:43'),
(108, '3', 100, 300.00, 350.00, 4000, 0.00, 30000.00, 1, 53, '2025-10-30 11:21:09');
...
--
ALTER TABLE `list_productsell`
  MODIFY `list_sellid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=678;

--
-- AUTO_INCREMENT for table `name_product`
--
ALTER TABLE `name_product`
  MODIFY `id_name` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `orders_sell`
--
ALTER TABLE `orders_sell`
  MODIFY `id_ordersell` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
...
--
ALTER TABLE `sell_typepay`
  MODIFY `typepay_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
